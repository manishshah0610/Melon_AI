...
//package com.example.newvideocallfinal;
...
public class MainActivity_videocall extends AppCompatActivity implements Session.SessionListener, PublisherKit.PublisherListener {
    ...
    private static String LOG_TAG = MainActivity_videocall.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_videocall);
